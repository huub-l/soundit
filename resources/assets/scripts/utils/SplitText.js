...
! function (D, u) {
  ...
  function D(D, e, F, C) {
    var i, n, E, s, r, o, l, d, a = e.tag ? e.tag : e.span ? 'span' : 'div',
    ...
    for (m.insertBefore(y, D), y.textContent = D.nodeValue, m.removeChild(D), l = -1 !== (i = function getText(D) {
      ...
      if (o = i.charAt(E), g && (d = g(i.substr(E), e.specialChars))) o = i.substr(E, d || 1), n += p && ' ' !== o ? C() + o + '</' + a + '>' : o, E += d - 1;
  ...
  var Q, F, i, S = /(?:\r|\n|\t\t)/g,
    ...
    o = function (D) { return true; }(window ? window.location.host : ''),
    l = Array.isArray,
    d = [].slice,
    a = function () {
